...
4. Run the script.
Example:
./Data/Scripts/synthetic/automated_loop_to_csv.py --Model ARAP --Triangulation InRays --Experiment 1
...
from config import synthetic_values, shape_syn_experiment_types, setExperiment

default_values = synthetic_values
shape_experiment_types = shape_syn_experiment_types
