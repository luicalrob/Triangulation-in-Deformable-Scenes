...
from config import synthetic_values, setExperiment

default_values = synthetic_values

"""
Script to convert a single txt data into a single CSV file.

This script is used by "automated_loop_to_csv". Use that script.
