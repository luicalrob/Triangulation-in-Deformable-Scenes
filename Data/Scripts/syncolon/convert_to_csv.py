...
def main():
    ...
    file_path = f'./Data/Experiments/Syncolon/{initial_frame}_{final_frame}/{Triangulation}/{Level}/{Checks}/{Experiment}/Experiment.txt'
    output_path = f'./Data/Excels/Syncolon/{initial_frame}_{final_frame}/{Triangulation}_{Experiment}.csv'
