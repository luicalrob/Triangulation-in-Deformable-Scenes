...
#include "DatasetLoader/SyncolonLoader.h"
...
int main(int argc, char **argv){
    ...
    if(argc < 2 && argc > 5){
        ...
        cerr << "\t./Syncolon <dataset_path>" << endl;
        cerr << "Or with 4 parameter: " << argc << endl;
        cerr << "\t./Syncolon <dataset_path> (int)Starting frame (int)Frames step (int)Ending frame" << endl;
    ...
    SyncolonLoader sequence(datasetPath, datasetPath + "/trajectory.txt");
    ...
    SLAM SLAM("Data/Syncolon.yaml", currPose);
